...
//    Print country, area key value pairs as map object.
        ...
        public void apacheTask() throws IOException {
            ...
            //    Add the excel file on the resources folder.
            String path = "src/test/java/Resouruces/excelfile.xlsx";
            ...
            int totalRows = sheet1.getPhysicalNumberOfRows(); // Satir sayisini atadik//    Print country, area key value pairs as map object.
